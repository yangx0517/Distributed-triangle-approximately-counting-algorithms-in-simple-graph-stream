...
void run_exp (const char* input, const char* outPath, MPIIO &hIO, int workerNum, int aggNum, int memSize, int repeat, int bufLen=1000, double tolerance=0.2);

void print_cnt(const char* outPath, double globalCnt, int id = 0,double elapsedTime=0);
