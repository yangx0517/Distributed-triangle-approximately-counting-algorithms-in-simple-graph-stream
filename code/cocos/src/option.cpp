...
static struct option long_options[] = {
	...
	{"theta", required_argument, 0, SIZE_THETA}, 
	{0, 0, 0, 0}
};
...
void Option::print()
{
	...
	cout << Option::inFileName << "\t" << Option::outPath << "\t" << Option::budget << "\t" << Option::theta << "\t" << Option::tolerance << "\t" << Option::trial << endl;
	cout << endl;
